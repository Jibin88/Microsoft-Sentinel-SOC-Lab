...
**Microsoft Sentinel -- Windows Security Monitoring & Failed Logon
Detection**

Built a hands-on SOC monitoring lab using Microsoft Sentinel, Azure
Monitor Agent, Azure Arc, Log Analytics, and Data Collection Rules.
Simulated controlled SMB authentication failures from Kali Linux,
investigated Windows Event ID 4625, developed KQL-based detection logic
for repeated failed logons, and configured a scheduled Sentinel
Analytics Rule for security monitoring.

## Disclaimer

This project was performed in an isolated, controlled lab environment
using personally controlled virtual machines for cybersecurity learning
and SOC monitoring practice.
